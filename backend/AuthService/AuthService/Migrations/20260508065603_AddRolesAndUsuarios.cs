...
{
    /// <inheritdoc />
    public partial class AddRolesAndUsuarios : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Facultad = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IdRol = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Guardia de seguridad", "Guardia" },
                    { 3, "Estudiante de la UTA", "Estudiante" },
                    { 4, "Docente de la UTA", "Docente" }
                });
